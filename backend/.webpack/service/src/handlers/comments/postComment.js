...
/***/ "./src/handlers/comments/postComment.ts":
/*!**********************************************!*\
  !*** ./src/handlers/comments/postComment.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"handler\": () => (/* binding */ handler)\n/* harmony export */ });\n/* harmony import */ var source_map_support_register__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! source-map-support/register */ \"source-map-support/register\");\n/* harmony import */ var source_map_support_register__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(source_map_support_register__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var http_errors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! http-errors */ \"http-errors\");\n/* harmony import */ var http_errors__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(http_errors__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _src_middlewares_middy__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @src/middlewares/middy */ \"./src/middlewares/middy.ts\");\n/* harmony import */ var _src_models_Comment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @src/models/Comment */ \"./src/models/Comment.ts\");\n/* harmony import */ var _src_models_Article__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @src/models/Article */ \"./src/models/Article.ts\");\n\n\n\n\n\nconst postComment = async (event) => {\n    try {\n        const { content, postFor, postType, authUser } = JSON.parse(event.body);\n        if (postType === 'article') {\n            const comment = new _src_models_Comment__WEBPACK_IMPORTED_MODULE_3__.default({ content, postBy: authUser._id });\n            await comment.save();\n            await _src_models_Article__WEBPACK_IMPORTED_MODULE_4__.default.findByIdAndUpdate(postFor, {\n                $push: { comments: comment._id },\n            });\n        }\n        else if (postType === 'comment') {\n            const comment = new _src_models_Comment__WEBPACK_IMPORTED_MODULE_3__.default({ content, postBy: authUser._id });\n            await comment.save();\n            await _src_models_Comment__WEBPACK_IMPORTED_MODULE_3__.default.findByIdAndUpdate(postFor, {\n                $push: { comments: comment._id },\n            });\n        }\n        else {\n            throw new Error('postType is invalid.');\n        }\n        return {\n            statusCode: 200,\n            body: JSON.stringify({ message: 'OK' }),\n        };\n    }\n    catch (error) {\n        throw new (http_errors__WEBPACK_IMPORTED_MODULE_1___default().InternalServerError)(JSON.stringify({ message: error.message }));\n    }\n};\nconst handler = (0,_src_middlewares_middy__WEBPACK_IMPORTED_MODULE_2__.authMiddleware)(postComment);\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./src/handlers/comments/postComment.ts\n");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/handlers/comments/postComment.ts");
