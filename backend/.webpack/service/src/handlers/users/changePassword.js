...
/***/ "./src/handlers/users/changePassword.ts":
/*!**********************************************!*\
  !*** ./src/handlers/users/changePassword.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"handler\": () => (/* binding */ handler)\n/* harmony export */ });\n/* harmony import */ var source_map_support_register__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! source-map-support/register */ \"source-map-support/register\");\n/* harmony import */ var source_map_support_register__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(source_map_support_register__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _src_middlewares_middy__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @src/middlewares/middy */ \"./src/middlewares/middy.ts\");\n/* harmony import */ var http_errors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! http-errors */ \"http-errors\");\n/* harmony import */ var http_errors__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(http_errors__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _src_models_User__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @src/models/User */ \"./src/models/User.ts\");\n/* harmony import */ var bcryptjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! bcryptjs */ \"bcryptjs\");\n/* harmony import */ var bcryptjs__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(bcryptjs__WEBPACK_IMPORTED_MODULE_4__);\n\n\n\n\n\nconst changePassword = async (event) => {\n    try {\n        const { authUser, oldPassword, newPassword } = JSON.parse(event.body);\n        if (oldPassword === newPassword) {\n            throw new Error('New password must be different from old one.');\n        }\n        const user = await _src_models_User__WEBPACK_IMPORTED_MODULE_3__.default.findById(authUser._id);\n        if (!user)\n            throw new Error('User not found.');\n        if (!user.password || !bcryptjs__WEBPACK_IMPORTED_MODULE_4___default().compareSync(oldPassword, user.password)) {\n            throw new Error('Incorrect password.');\n        }\n        user.password = await _src_models_User__WEBPACK_IMPORTED_MODULE_3__.default.generateHashPassword(newPassword);\n        await user.save();\n        return {\n            statusCode: 200,\n            body: JSON.stringify({ success: true }),\n        };\n    }\n    catch (error) {\n        throw new (http_errors__WEBPACK_IMPORTED_MODULE_2___default().InternalServerError)(JSON.stringify({ message: error.message }));\n    }\n};\nconst handler = (0,_src_middlewares_middy__WEBPACK_IMPORTED_MODULE_1__.authMiddleware)(changePassword);\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./src/handlers/users/changePassword.ts\n");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/handlers/users/changePassword.ts");
