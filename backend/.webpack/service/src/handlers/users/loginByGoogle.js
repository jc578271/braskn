...
/***/ "./src/handlers/users/loginByGoogle.ts":
/*!*********************************************!*\
  !*** ./src/handlers/users/loginByGoogle.ts ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"handler\": () => (/* binding */ handler)\n/* harmony export */ });\n/* harmony import */ var source_map_support_register__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! source-map-support/register */ \"source-map-support/register\");\n/* harmony import */ var source_map_support_register__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(source_map_support_register__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var http_errors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! http-errors */ \"http-errors\");\n/* harmony import */ var http_errors__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(http_errors__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _src_models_User__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @src/models/User */ \"./src/models/User.ts\");\n/* harmony import */ var _src_middlewares_middy__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @src/middlewares/middy */ \"./src/middlewares/middy.ts\");\n/* harmony import */ var jwt_decode__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! jwt-decode */ \"jwt-decode\");\n/* harmony import */ var jwt_decode__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(jwt_decode__WEBPACK_IMPORTED_MODULE_4__);\n\n\n\n\n\nconst loginByGoogle = async (event) => {\n    try {\n        const { email, firstName, lastName, avatar, authToken } = JSON.parse(event.body);\n        const decodeToken = jwt_decode__WEBPACK_IMPORTED_MODULE_4___default()(authToken);\n        if (decodeToken.email !== email &&\n            decodeToken.iss !== 'accounts.google.com')\n            throw new (http_errors__WEBPACK_IMPORTED_MODULE_1___default().InternalServerError)('Token is invalid.');\n        const user = await _src_models_User__WEBPACK_IMPORTED_MODULE_2__.default.findOne({ email, accountType: 'GoogleAuth' });\n        if (!user) {\n            const newUser = new _src_models_User__WEBPACK_IMPORTED_MODULE_2__.default({\n                email,\n                firstName,\n                lastName,\n                avatar,\n                accountType: 'GoogleAuth',\n            });\n            const token = await newUser.generateSessionToken();\n            await newUser.save();\n            newUser.password = undefined;\n            newUser.token = undefined;\n            return {\n                statusCode: 200,\n                body: JSON.stringify({ user: newUser, token }),\n            };\n        }\n        const token = await user.generateSessionToken();\n        user.password = undefined;\n        user.token = undefined;\n        return {\n            statusCode: 200,\n            body: JSON.stringify({ user, token }),\n        };\n    }\n    catch (error) {\n        throw new (http_errors__WEBPACK_IMPORTED_MODULE_1___default().InternalServerError)(JSON.stringify({ message: error.message }));\n    }\n};\nconst handler = (0,_src_middlewares_middy__WEBPACK_IMPORTED_MODULE_3__.commonMiddleware)(loginByGoogle);\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./src/handlers/users/loginByGoogle.ts\n");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/handlers/users/loginByGoogle.ts");
