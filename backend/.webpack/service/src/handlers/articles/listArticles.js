...
/***/ "./src/handlers/articles/listArticles.ts":
/*!***********************************************!*\
  !*** ./src/handlers/articles/listArticles.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"handler\": () => (/* binding */ handler)\n/* harmony export */ });\n/* harmony import */ var source_map_support_register__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! source-map-support/register */ \"source-map-support/register\");\n/* harmony import */ var source_map_support_register__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(source_map_support_register__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var http_errors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! http-errors */ \"http-errors\");\n/* harmony import */ var http_errors__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(http_errors__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _src_middlewares_middy__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @src/middlewares/middy */ \"./src/middlewares/middy.ts\");\n/* harmony import */ var _src_models_Article__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @src/models/Article */ \"./src/models/Article.ts\");\n/* harmony import */ var _src_models_Category__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @src/models/Category */ \"./src/models/Category.ts\");\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! mongoose */ \"mongoose\");\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(mongoose__WEBPACK_IMPORTED_MODULE_5__);\n/* harmony import */ var _src_helpers_common__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @src/helpers/common */ \"./src/helpers/common.ts\");\n\n\n\n\n\n\n\nconst listArticles = async (event) => {\n    let findArgs = {};\n    const findTextKeys = ['title', 'description', 'content', 'author'];\n    const skip = event.queryStringParameters.skip\n        ? parseInt(event.queryStringParameters.skip)\n        : 0;\n    const limit = event.queryStringParameters.limit\n        ? parseInt(event.queryStringParameters.limit)\n        : 6;\n    const sortBy = event.queryStringParameters.sortBy\n        ? event.queryStringParameters.sortBy\n        : 'createdAt';\n    const order = event.queryStringParameters.order\n        ? event.queryStringParameters.order\n        : 'desc';\n    const setTextArgs = (textKeys) => {\n        let textArgs = [];\n        textKeys.map((key) => {\n            let findObj = {};\n            findObj[key] = {\n                $regex: (0,_src_helpers_common__WEBPACK_IMPORTED_MODULE_6__.parseQueryText)((0,_src_helpers_common__WEBPACK_IMPORTED_MODULE_6__.parseQueryText)(event.queryStringParameters.text)),\n                $options: 'i',\n            };\n            textArgs.push(findObj);\n        });\n        return textArgs;\n    };\n    for (let key in event.queryStringParameters) {\n        if (key !== 'skip' &&\n            key !== 'limit' &&\n            key !== 'sortBy' &&\n            key !== 'order' &&\n            key !== 'text' &&\n            key !== 'author') {\n            findArgs[key] = event.queryStringParameters[key].toLowerCase();\n        }\n        else if (key === 'text') {\n            findArgs['$or'] = setTextArgs(findTextKeys);\n        }\n    }\n    try {\n        const articles = await _src_models_Article__WEBPACK_IMPORTED_MODULE_3__.default.find(findArgs)\n            .skip(skip)\n            .limit(limit)\n            .sort([[sortBy, order]])\n            .populate({\n            path: 'category',\n            model: _src_models_Category__WEBPACK_IMPORTED_MODULE_4__.default,\n            select: 'name -_id',\n        });\n        if (!articles) {\n            throw new mongoose__WEBPACK_IMPORTED_MODULE_5__.Error('No article found.');\n        }\n        return {\n            statusCode: 200,\n            body: JSON.stringify({ success: true, size: articles.length, articles }),\n        };\n    }\n    catch (error) {\n        throw new (http_errors__WEBPACK_IMPORTED_MODULE_1___default().InternalServerError)(JSON.stringify({ message: error.message }));\n    }\n};\nconst handler = (0,_src_middlewares_middy__WEBPACK_IMPORTED_MODULE_2__.commonMiddleware)(listArticles);\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./src/handlers/articles/listArticles.ts\n");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"parseQueryText\": () => (/* binding */ parseQueryText)\n/* harmony export */ });\nconst parseQueryText = (text) => text.split('-').join(' ').toLowerCase();\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./src/helpers/common.ts\n");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/handlers/articles/listArticles.ts");
